...
import net.mcreator.wild_world.block.MidnightMangroveSaplingBlock;
...
public class MidnightMangroveTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState TRUNK = MarshWoodLogBlock.block.getDefaultState();
   private static final BlockState LEAF = MarshLeavesBlock.block.getDefaultState();
   private static final BlockState NODE = LuminodeBlock.block.getDefaultState();

   public MidnightMangroveTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51425_1_, boolean doBlockNotifyIn) {
      super(p_i51425_1_, doBlockNotifyIn);
      this.setSapling((net.minecraftforge.common.IPlantable)MidnightMangroveSaplingBlock.block);
   }
