...
public class MidnightMangroveFenceBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:midnightmangrovefence")
	public static final Block block = null;
	public MidnightMangroveFenceBlock(WildWorldElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("midnightmangrovefence");
		}
