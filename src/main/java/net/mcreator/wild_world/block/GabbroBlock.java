...
public class GabbroBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:gabbro")
	public static final Block block = null;
	public GabbroBlock(WildWorldElements instance) {
		super(instance, 449);
	}
