...
import net.mcreator.wild_world.item.ShardDiamondItem;
...
public class DiamondCrystalBlock extends WildWorldElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.DIAMOND).doesNotBlockMovement().sound(SoundType.GLASS)
					.hardnessAndResistance(3f, 3f).lightValue(0));
			setRegistryName("diamondcrystal");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ShardDiamondItem.block, (int) (1)));
		}
