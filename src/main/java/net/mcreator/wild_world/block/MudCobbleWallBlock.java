...
public class MudCobbleWallBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:mudcobblewall")
	public static final Block block = null;
	public MudCobbleWallBlock(WildWorldElements instance) {
		super(instance, 86);
	}
