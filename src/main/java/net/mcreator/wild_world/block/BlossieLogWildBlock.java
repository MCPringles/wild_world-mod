...
public class BlossieLogWildBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:blossielogwild")
	public static final Block block = null;
	public BlossieLogWildBlock(WildWorldElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends LogBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("blossielogwild");
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlossieLogBlock.block, (int) (1)));
		}
	}
}
