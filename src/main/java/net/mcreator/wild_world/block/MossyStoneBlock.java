...
public class MossyStoneBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:mossystone")
	public static final Block block = null;
	public MossyStoneBlock(WildWorldElements instance) {
		super(instance, 453);
	}
