...
public class PalmFenceBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:palmfence")
	public static final Block block = null;
	public PalmFenceBlock(WildWorldElements instance) {
		super(instance, 90);
	}
