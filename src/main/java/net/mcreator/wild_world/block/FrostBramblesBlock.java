...
public class FrostBramblesBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:frostbrambles")
	public static final Block block = null;
	public FrostBramblesBlock(WildWorldElements instance) {
		super(instance, 97);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.ICE).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("frostbrambles");
		}
