...
public class BlossieFenceBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:blossiefence")
	public static final Block block = null;
	public BlossieFenceBlock(WildWorldElements instance) {
		super(instance, 88);
	}
