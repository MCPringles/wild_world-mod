...
public class DriftwoodFenceBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:driftwoodfence")
	public static final Block block = null;
	public DriftwoodFenceBlock(WildWorldElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("driftwoodfence");
		}
