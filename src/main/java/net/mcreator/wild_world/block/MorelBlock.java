...
public class MorelBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:morel")
	public static final Block block = null;
	public MorelBlock(WildWorldElements instance) {
		super(instance, 100);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.AIR).doesNotBlockMovement()
					.sound(SoundType.NETHER_WART).hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("morel");
		}
