...
import net.mcreator.wild_world.procedures.StarRepeaterOffTickProcedure;
...
public class YronStarBoxOffBlock extends WildWorldElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("yronstarboxoff"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yronstarboxoff");
		}
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				StarRepeaterOffTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("yronstarboxoff");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Starpower Junction");
		}
