...
public class TruffleBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:truffle")
	public static final Block block = null;
	public TruffleBlock(WildWorldElements instance) {
		super(instance, 101);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.BLACK).doesNotBlockMovement()
