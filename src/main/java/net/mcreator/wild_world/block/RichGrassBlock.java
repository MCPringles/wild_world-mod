...
public class RichGrassBlock extends WildWorldElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.PLANT).hardnessAndResistance(1.5f, 3.5f).lightValue(0).harvestLevel(-1)
					.harvestTool(ToolType.SHOVEL).tickRandomly());
			setRegistryName("richgrass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RichSoilBlock.block, (int) (1)));
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("richgrass", "richgrass", blockAt -> {
