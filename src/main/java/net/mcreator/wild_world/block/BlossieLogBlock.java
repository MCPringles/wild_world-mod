...
public class BlossieLogBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:blossielog")
	public static final Block block = null;
	public BlossieLogBlock(WildWorldElements instance) {
		super(instance, 15);
	}
