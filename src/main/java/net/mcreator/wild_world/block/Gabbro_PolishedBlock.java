...
public class Gabbro_PolishedBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:gabbro_polished")
	public static final Block block = null;
	public Gabbro_PolishedBlock(WildWorldElements instance) {
		super(instance, 450);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gabbro_polished");
		}
