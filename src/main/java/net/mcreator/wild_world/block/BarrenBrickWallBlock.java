...
public class BarrenBrickWallBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:barrenbrickwall")
	public static final Block block = null;
	public BarrenBrickWallBlock(WildWorldElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("barrenbrickwall");
		}
