...
public class LogWillowBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:logwillow")
	public static final Block block = null;
	public LogWillowBlock(WildWorldElements instance) {
		super(instance, 456);
	}
