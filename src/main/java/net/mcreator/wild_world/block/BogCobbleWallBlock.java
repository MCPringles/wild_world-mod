...
public class BogCobbleWallBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:bogcobblewall")
	public static final Block block = null;
	public BogCobbleWallBlock(WildWorldElements instance) {
		super(instance, 87);
	}
