...
public class PeridotiteBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:peridotite")
	public static final Block block = null;
	public PeridotiteBlock(WildWorldElements instance) {
		super(instance, 460);
	}
