...
public class MapleLogWildBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:maplelogwild")
	public static final Block block = null;
	public MapleLogWildBlock(WildWorldElements instance) {
		super(instance, 168);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MapleLogBlock.block, (int) (1)));
		}
	}
}
