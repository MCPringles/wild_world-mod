...
public class WillowPlanksBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:willowplanks")
	public static final Block block = null;
	public WillowPlanksBlock(WildWorldElements instance) {
		super(instance, 457);
	}
