...
public class PalmLogBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:palmlog")
	public static final Block block = null;
	public PalmLogBlock(WildWorldElements instance) {
		super(instance, 16);
	}
