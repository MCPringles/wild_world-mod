...
public class MorningOrchidBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:morningorchid")
	public static final Block block = null;
	public MorningOrchidBlock(WildWorldElements instance) {
		super(instance, 425);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.SNOW).doesNotBlockMovement()
					.sound(SoundType.WET_GRASS).hardnessAndResistance(0f, 0f).lightValue(6));
			setRegistryName("morningorchid");
		}
