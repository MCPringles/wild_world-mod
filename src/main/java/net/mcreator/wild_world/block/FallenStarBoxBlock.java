...
import net.mcreator.wild_world.procedures.StarAltarActivatedProcedure;
...
public class FallenStarBoxBlock extends WildWorldElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2f, 64000f).lightValue(3).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("fallenstarbox");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				StarAltarActivatedProcedure.executeProcedure($_dependencies);
			}
		}
