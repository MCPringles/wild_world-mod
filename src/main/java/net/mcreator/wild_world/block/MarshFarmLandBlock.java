...
public class MarshFarmLandBlock extends WildWorldElements.ModElement {
	...
	public static class CustomBlock extends FarmlandBlock {
		...
		public BlockState getStateForPlacement(BlockItemUseContext context) {
      		return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? MarshDirtBlock.block.getDefaultState() : super.getStateForPlacement(context);
   		}
		...
		public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
   		...
   		public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
      		if (!worldIn.isRemote && net.minecraftforge.common.ForgeHooks.onFarmlandTrample(worldIn, pos, MarshDirtBlock.block.getDefaultState(), fallDistance, entityIn)) { // Forge: Move logic to Entity#canTrample
