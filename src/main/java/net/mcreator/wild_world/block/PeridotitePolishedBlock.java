...
public class PeridotitePolishedBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:peridotitepolished")
	public static final Block block = null;
	public PeridotitePolishedBlock(WildWorldElements instance) {
		super(instance, 461);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peridotitepolished");
		}
