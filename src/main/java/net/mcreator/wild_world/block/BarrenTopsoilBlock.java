...
public class BarrenTopsoilBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:barrentopsoil")
	public static final Block block = null;
	public BarrenTopsoilBlock(WildWorldElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.8f, 3.5f).lightValue(0).harvestLevel(-1)
					.harvestTool(ToolType.SHOVEL));
			setRegistryName("barrentopsoil");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BarrenDirtBlock.block, (int) (1)));
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("barrentopsoil", "barrentopsoil", blockAt -> {
