...
public class StarBoxSourceBlock extends WildWorldElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("starboxsource"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("starboxsource");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Starpower Source");
		}
