...
public class MarshWoodLogBlock extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:marshwoodlog")
	public static final Block block = null;
	public MarshWoodLogBlock(WildWorldElements instance) {
		super(instance, 376);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(-1)
					.harvestTool(ToolType.AXE).slipperiness(0.7f).tickRandomly());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("marshwoodlog");
		}
