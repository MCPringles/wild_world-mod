...
public class StarEmeraldItem extends WildWorldElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("By direct energy transfer,"));
			list.add(new StringTextComponent("it can fortify blocks."));
		}
	}
}
