...
public class FallenStarItemItem extends WildWorldElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fallenstaritem");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("It radiates a strange, gloomy energy"));
		}
	}
}
