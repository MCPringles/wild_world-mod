...
public class TropicalHighlandsBiome extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:tropicalhighlands")
	public static final CustomBiome biome = null;
	public TropicalHighlandsBiome(WildWorldElements instance) {
		super(instance, 384);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(1f).depth(0.32f).scale(0.06f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.EXTREME_HILLS).waterColor(-12331538).waterFogColor(-12331538).parent("wild_world:tropicalmidlands")
			...
			setRegistryName("tropicalhighlands");
			...
			addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.GRASS,
					new GrassFeatureConfig(Blocks.GRASS.getDefaultState()), Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(6)));
