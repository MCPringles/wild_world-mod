...
public class TropicalMidlandsBiome extends WildWorldElements.ModElement {
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(1f).depth(0.02f).scale(0.01f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.EXTREME_HILLS).waterColor(-12331538).waterFogColor(-12331538).parent("wild_world:tropicallowlands")
			...
			setRegistryName("tropicalmidlands");
