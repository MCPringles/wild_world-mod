...
public class MapleForestColdBiome extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:mapleforestcold")
	public static final CustomBiome biome = null;
	public MapleForestColdBiome(WildWorldElements instance) {
		super(instance, 165);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.COLD,
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.15f).scale(0.1f).temperature(-0.2f).precipitation(Biome.RainType.SNOW)
			...
			setRegistryName("mapleforestcold");
