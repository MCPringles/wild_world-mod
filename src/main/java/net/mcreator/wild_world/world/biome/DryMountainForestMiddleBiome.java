...
public class DryMountainForestMiddleBiome extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:drymountainforestmiddle")
	public static final CustomBiome biome = null;
	public DryMountainForestMiddleBiome(WildWorldElements instance) {
		super(instance, 155);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HOT,
				BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.DENSE);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.DESERT, new BiomeManager.BiomeEntry(biome, 2));
	}
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.3f).depth(0.26f).scale(0.16f).temperature(1f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.NONE).waterColor(-14329397).waterFogColor(-14329397).parent("wild_world:drymountain")
			...
			setRegistryName("drymountainforestmiddle");
