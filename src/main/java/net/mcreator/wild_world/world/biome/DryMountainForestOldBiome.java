...
public class DryMountainForestOldBiome extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:drymountainforestold")
	public static final CustomBiome biome = null;
	public DryMountainForestOldBiome(WildWorldElements instance) {
		super(instance, 156);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HOT,
				BiomeDictionary.Type.DENSE, BiomeDictionary.Type.DRY);
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.3f).depth(0.26f).scale(0.16f).temperature(1f).precipitation(Biome.RainType.RAIN)
					.category(Biome.Category.NONE).waterColor(-14329397).waterFogColor(-14329397).parent("wild_world:drymountainforestmiddle")
			...
			setRegistryName("drymountainforestold");
