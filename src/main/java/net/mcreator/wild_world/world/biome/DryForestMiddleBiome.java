...
public class DryForestMiddleBiome extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:dryforestmiddle")
	public static final CustomBiome biome = null;
	public DryForestMiddleBiome(WildWorldElements instance) {
		super(instance, 152);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE,
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			setRegistryName("dryforestmiddle");
