...
public class WahsatchDimension extends WildWorldElements.ModElement {
	@ObjectHolder("wild_world:wahsatch")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public WahsatchDimension(WildWorldElements instance) {
		super(instance, 370);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("wahsatch"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("wild_world:wahsatch")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("wild_world:wahsatch"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("wild_world:wahsatch"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("wild_world:dryforestmiddle")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("wild_world:drymountain")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("wild_world:drymountainforestold")),};
	}
