...
import net.mcreator.wild_world.block.YronStarPillarOnBlock;
import net.mcreator.wild_world.WildWorldElements;

@WildWorldElements.ModElement.Tag
public class YronStarPillarOffTickProcedure extends WildWorldElements.ModElement {
	public YronStarPillarOffTickProcedure(WildWorldElements instance) {
		super(instance, 319);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure YronStarPillarOffTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure YronStarPillarOffTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure YronStarPillarOffTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure YronStarPillarOffTick!");
			return;
		}
		...
		if (((new Object() {
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), YronStarPillarOnBlock.block.getDefaultState(), 3);
				try {
