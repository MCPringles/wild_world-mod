...
public class MapleTapEventsProcedure extends WildWorldElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MapleTapEvents!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MapleTapEvents!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MapleTapEvents!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MapleTapEvents!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MapleTapEvents!");
			return;
		}
				...
				if ((Math.random() >= 0.25)) {
					if (!world.isRemote) {
						ItemEntity entityToSpawn = new ItemEntity(world, (x + (((entity.posX) - x) / 2)), y, (z + (((entity.posZ) - z) / 2)),
								new ItemStack(SapItemItem.block, (int) (1)));
