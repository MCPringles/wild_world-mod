...
public class ThawDirtProcedure extends WildWorldElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure ThawDirt!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure ThawDirt!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure ThawDirt!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure ThawDirt!");
			return;
		}
					...
					for (int index4 = 0; index4 < (int) (5); index4++) {
						...
						for (int index5 = 0; index5 < (int) (3); index5++) {
							if (((world.getBlockState(new BlockPos((int) (x + (GrassX)), (int) (y + (GrassY)), (int) (z + (GrassZ)))))
									.getBlock() == FrigidTopsoilBlock.block.getDefaultState().getBlock())) {
